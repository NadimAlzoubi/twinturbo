    ...
    <br>
    <br>
    <footer style="text-align:center; padding: 4px; width: 100%; position: absolute; bottom: 0;">
        Copyright © 2023 - <?php echo date('Y'); ?> Nadim Al-Zoubi® |
        <a style="color: #00c800 !important;" href="<?php echo $nadim->website_link; ?>" target="_blank"><?php echo $nadim->website; ?></a> | All rights reserved | v<?php echo $nadim->next_version; ?>
    </footer>
